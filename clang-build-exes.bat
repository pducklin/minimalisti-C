...
echo:
echo:
echo -1----CREATE BOOTSTRAP COMPILER WITH CLANG----------------------
echo Building clang.out.exe using LLVM/Clang...
echo  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 

"C:\Program Files\LLVM\bin\clang.exe" -o clang.out.exe -Wno-deprecated-declarations -Wno-pointer-sign tcc.c
echo -1--------------------------------------------------------------


echo:
echo:
echo -2----BUILD INTERMEDIATE FILES WITH CLANG-GENERATED TCC CODE----
echo Building components with clang.out.exe...
echo  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
