...
/* £££ vvv ADDED because PETCC64 could do with these for building luax   */
/* (Don't need THREAD and VOLUME stuff, but aligns with current headers) */
...
/* £££ vvv ADDED to help PETCC64 build LFS in luax */ 
#define SYMBOLIC_LINK_FLAG_DIRECTORY (0x1)
#define SYMBOLIC_LINK_FLAG_ALLOW_UNPRIVILEGED_CREATE (0x2)

#define VALID_SYMBOLIC_LINK_FLAGS SYMBOLIC_LINK_FLAG_DIRECTORY

  WINBASEAPI WINBOOL WINAPI CreateSymbolicLinkA (LPCSTR lpSymlinkFileName, LPCSTR lpTargetFileName, DWORD dwFlags);
  WINBASEAPI WINBOOL WINAPI CreateSymbolicLinkW (LPCWSTR lpSymlinkFileName, LPCWSTR lpTargetFileName, DWORD dwFlags); 
...
#endif  
/* £££ ^^^ ADDED to help PETCC64 build LFS in luax */  
