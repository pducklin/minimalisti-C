...
/* vvv Added £££ from more recent Windows to avoid wholesale header updates */
...
#ifdef UNICODE
// duck #define gai_strerror gai_strerrorW
#define gai_strerror(x) (L"addrinfo error")
#else
//duck #define gai_strerror gai_strerrorA
#define gai_strerror(x) ("addrinfo error")
#endif
