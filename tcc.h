...
/* £££ these are also set in config.h */
...
struct TCCState {
    ...
    int nostdinc; /* if true, no standard header paths are searched */
    ...
    int sudefs; /* if true, pre-#define S08/U08/S16 etc. for include-free convenience */
